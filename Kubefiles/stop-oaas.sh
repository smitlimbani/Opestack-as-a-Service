...
kubectl label nodes oaas-34gc5 node-role.kubernetes.io/master=
kubectl label nodes oaas-34gck controller= compute= nfs-server=
kubectl label nodes oaas-34gch controller= compute=
kubectl label nodes oaas-34gc4 controller= compute=
kubectl label nodes oaas-34gci network=
kubectl label nodes oaas-34gcv network=